...
--
-- Host: localhost    Database: test_1125_stolbov_kurs
-- ------------------------------------------------------
...
INSERT INTO `room` VALUES (101,20,0,1,1500),(102,22,1,1,1500),(201,35,0,2,3000);
...
INSERT INTO `roomclass` VALUES (1,'Стандарт'),(2,'Люкс');
/*!40000 ALTER TABLE `roomclass` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'test_1125_stolbov_kurs'
--
...
-- Dump completed on 2026-06-22  1:33:29
